let location = ["enter location","Amaravati", "Anantapur", "Chandragiri", "Chittoor", "Dowlaiswaram", "Eluru", "Guntur", "Kadapa", "Kakinada", "Kurnool", "Machilipatnam", "Nagarjunako", "Rajahmundry", "Srikakulam",
...
let jobRole = ["enter job role","Marketing Manager", "Marketing Director", "Graphic Designer", "Marketing Research Analyst", "Marketing Communications Manager", "Marketing Consultant", -"Store Manager", "Account Executive",
...
let primarySkills = [
    ...
    "C","Java","Java Script","Perl","PHP","Python","Swift","Go","SQL","R","Ruby","Google Suite","Trello","Slack","Zapier","Zoom","JIRA","Salesforce","Budget planning","Risk management",
